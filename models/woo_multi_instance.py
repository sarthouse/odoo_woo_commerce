...
class WooInstance(models.Model):
    ...
    def login(self):
        try:
            ...
            raise UserError(
                _("Connection Unsuccessful..!! \nPlease check your URL, Consumer Key, Consumer Secret or Refresh Connection")
            )
        ...
        if r.status_code == 200:
            return {
                ...
                'name': _('Success'),
                'view_mode': 'form',
                'res_model': 'woo.authentication.response.wizard',
                'context': {'default_authentication_response': _("Congratulations !!! WooCommerce and Odoo Connection has been Successfully Established")},
            }
        else:
            raise UserError(
                _("Connection Unsuccessful..!! \nPlease check your URL, Consumer Key, Consumer Secret or Refresh Connection")
